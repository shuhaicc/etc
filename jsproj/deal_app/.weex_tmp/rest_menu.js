...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(74), (function() { return this; }()), __webpack_require__(75).setImmediate))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/home/scui/projs/IM/deal_app/src/rest_menu.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
	if (Component.options.functional) {console.error("[vue-loader] rest_menu.vue: functional components are not supported with templates, they should use render functions.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-4ef1680c", Component.options)
	  } else {
	    hotAPI.reload("data-v-4ef1680c", Component.options)
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _vueScrollactive = __webpack_require__(122);
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        _axios2.default.get(this.config.restApi + "/v1/restaurants/" + this.restId + "/catalogues_menus?menu_type=is_preorder").then(function (response) {
	            var chineseArr = [];
	            _axios2.default.get(_this.config.restApi + "/v1/restaurants/" + _this.restId + "/catalogues_menus?menu_type=is_preorder&locale=zh_CN").then(function (chineseResponse) {
	                chineseArr = (0, _keys2.default)(chineseResponse.data);
	                _this.posts = response.data;
	                _this.cataArr = (0, _keys2.default)(_this.posts);
	                var that = _this;
	                for (var i = 0; i < _this.cataArr.length; i++) {
	                    var catKey = _this.cataArr[i];
	                    var item = _this.posts[catKey];
	                    _this.itemArr.push(item);
	                }
	                var tempArr = [];
	                _this.formatCats = [];
	                for (var _i = 0; _i < _this.cataArr.length; _i++) {
	                    var tempObj = {
	                        "en": _this.cataArr[_i],
	                        "cn": chineseArr[_i]
	                    };
	                    tempArr.push(tempObj);
	                    var clone = (0, _assign2.default)({}, tempObj);
	                    that.formatCats.push(clone);
	                }
	                _this.cataArr = tempArr;
	                for (var _i2 = 0; _i2 < _this.cataArr.length; _i2++) {
	                    if (_this.cataArr[_i2].en.length > 15) {
	                        var temp = that.cataArr[_i2].en;
	                        var subTemp = temp.substr(0, 15) + '...';
	                        that.cataArr[_i2].en = subTemp;
	                    }
	                    if (_this.cataArr[_i2].cn.length > 7) {
	                        var _temp = that.cataArr[_i2].cn;
	                        var _subTemp = _temp.substr(0, 7) + '...';
	                        that.cataArr[_i2].cn = _subTemp;
	                    }
	                }
	                console.log(_this.posts);
	                _this.dynamicItemsFunction();
	                console.log('CATA IS: ' + _this.cataArr);
	            }).catch(function (e) {});
	    ...
	    methods: {
	        ...
	        dynamicItemsFunction: function dynamicItemsFunction() {
	            // Add your items
	        ...
	        jump: function jump(anItem) {
	            var itemId = anItem._id;
	            var itemName = anItem.longNames;
	            var itemPic = void 0;
	            if (anItem.photos && anItem.photos.length > 0) {
	                itemPic = anItem.photos[0].path;
	            } else itemPic = 'npic';
	            var itemPrice = anItem.BasePrice;
	            var itemDesc = void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: "trans-cart"
	  }, [_c('div', {
	    staticClass: "clear",
	    style: ({
	      backgroundImage: 'url(' + _vm.transUrl + ')',
	      width: 0.0453 * _vm.bodyWidth + 'px',
	      height: 0.048 * _vm.bodyWidth + 'px'
	    }),
	    attrs: {
	      "id": "trans"
	    ...
	    style: ({
	      ...
	      width: 0.053 * _vm.bodyWidth + 'px',
	      height: 0.0613 * _vm.bodyWidth + 'px',
	    ...
	    style: ({
	      marginTop: 0.117 * _vm.bodyWidth + 'px'
	    })
	  }, [(_vm.locale === 'en_US') ? _c('div', {
	    staticClass: "catalogue"
	  }, [_c('scrollactive', {
	    ref: "scrollactive",
	    attrs: {
	      "offset": _vm.offset,
	      "always-track": _vm.alwaysTrack,
	      "duration": _vm.duration,
	      "click-to-scroll": _vm.clickToScroll,
	      "bezier-easing-value": _vm.easing
	    }
	  }, [_vm._l((_vm.cataArr), function(aCat) {
	    return _c('a', {
	      key: aCat,
	      staticClass: "each-cat scrollactive-item",
	      style: ({
	        height: 0.16 * _vm.bodyWidth + 'px',
	  ...
	  }, _vm._l((_vm.formatCats), function(aCat) {
	    return (_vm.formatCats.length > 0) ? _c('div', {
	      key: aCat,
	      staticClass: "each-cat-item",
	      style: ({
	        paddingTop: 0.06 * _vm.bodyWidth + 'px',
	        fontSize: 0.04 * _vm.bodyWidth + 'px',
	        fontWeight: '600'
	      }),
	      attrs: {
	    ...
	    }, [(_vm.locale === 'en_US') ? _c('span', [_vm._v(_vm._s(aCat.en))]) : (_vm.locale === 'zh_CN') ? _c('span', [_vm._v(_vm._s(aCat.cn))]) : _vm._e(), _vm._v(" "), _vm._l((_vm.posts[aCat.en]), function(anItem) {
	      return _c('div', {
	        key: anItem,
	        staticClass: "each-item",
	        style: ({
	          height: 0.533 * _vm.bodyWidth + 'px',
	          marginTop: 0.0453 * _vm.bodyWidth + 'px'
	        })
	      }, [(anItem.photos && anItem.photos.length > 0) ? _c('div', {
	        staticClass: "item-img",
	        style: ({
	          backgroundImage: 'url(' + _vm.addS(anItem.photos[0].path) + ')'
	        }),
	        on: {
	        ...
	        staticClass: "item-img",
	        style: ({
	          backgroundImage: 'url(' + _vm.nullUrl + ')'
	        }),
	        on: {
	          "click": function($event) {
	            _vm.jump(anItem)
	      ...
	      }), _vm._v(" "), (anItem.longNames[0].name.length > (0.072 * _vm.bodyWidth) && anItem.longNames[0].locale === _vm.locale) ? _c('div', [_c('div', {
	        staticClass: "item-name",
	        style: ({
	          marginTop: 0.0453 * _vm.bodyWidth + 'px'
	        })
	      }, [_vm._v("\n                            " + _vm._s(anItem.longNames[0].name.substr(0, Math.floor(0.06 * _vm.bodyWidth)) + '...') + "\n                        ")])]) : (anItem.longNames[1].name.length > (0.072 * _vm.bodyWidth) && anItem.longNames[0].locale === _vm.locale) ? _c('div', [_c('div', {
	        staticClass: "item-name",
	        style: ({
	          marginTop: 0.0453 * _vm.bodyWidth + 'px'
	        })
	      }, [_vm._v("\n                            " + _vm._s(anItem.longNames[1].name.substr(0, Math.floor(0.06 * _vm.bodyWidth)) + '...') + "\n                        ")])]) : (anItem.longNames[0].locale === _vm.locale) ? _c('div', [_c('div', {
	        staticClass: "item-name",
	        style: ({
	          marginTop: 0.0453 * _vm.bodyWidth + 'px'
	        })
	      }, [_vm._v("\n                            " + _vm._s(anItem.longNames[0].name) + "\n                        ")])]) : (anItem.longNames[1].locale === _vm.locale) ? _c('div', [_c('div', {
	        staticClass: "item-name",
	        style: ({
	          marginTop: 0.0453 * _vm.bodyWidth + 'px'
	        })
	      }, [_vm._v("\n                            " + _vm._s(anItem.longNames[1].name) + "\n                        ")])]) : _vm._e(), _vm._v(" "), _c('div', {
	        staticClass: "priceNcart",
	        style: ({
	          marginTop: 0.0453 * _vm.bodyWidth + 'px'
	        })
	      }, [_vm._v("\n                        " + _vm._s('$' + anItem.BasePrice) + "\n                        "), _c('div', {
	        staticClass: "add-cart",
	        style: ({
	          backgroundImage: 'url(' + _vm.redCartUrl + ')',
	          width: 0.064 * _vm.bodyWidth + 'px',
	          height: 0.064 * _vm.bodyWidth + 'px'
	        }),
	        on: {
	          "click": function($event) {
	            _vm.toCart(anItem)
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-4ef1680c", module.exports)
	  }
	}
