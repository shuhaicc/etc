...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/home/scui/projs/IM/csapp/src/components/lead.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-453661d2", Component.options)
	  } else {
	    hotAPI.reload("data-v-453661d2", Component.options)
	  }
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    jump: function jump(e, id, dist) {
	      this.$router.push({ path: '/merchant_info', query: { restId: id, dist: dist } });
	      this.selectedPath = e;
	      console.log(id);
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    return _c('li', {
	      ...
	      staticClass: "merchant-detail",
	      style: ({
	        height: _vm.windowHeight * 0.4047976 + 'px'
	      }),
	      on: {
	        "click": function($event) {
	          _vm.jump('/merchant_info', post._id, post.distance)
	        }
	      }
	    }, [_c('button', {
	      attrs: {
	      ...
	      on: {
	        "click": function($event) {
	          _vm.jump('/merchant_info', '12345', 12436)
	        }
	      }
	    }), _vm._v(" "), (post.photos && post.photos.length > 0) ? _c('div', {
	  ...
	  }, [_vm._v("Merchants")])]), _vm._v(" "), _c('div', {
	    staticClass: "button-container",
	    attrs: {
	      "id": "orders"
	    },
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-453661d2", module.exports)
	  }
	}
