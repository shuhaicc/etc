  ...
  <div class="wrapper">
    ...
    <div class="merchant-list">
      <ul v-if="posts && posts.length" style="list-style-type: none; padding:0">
        <li class='each-merchant' v-for="post in posts" v-bind:key="post" :id="post._id">
          ...
          <div class="merchant-detail" :style="{height:windowHeight * 0.4047976 + 'px'}"
             @click="jump('/merchant_info', post._id, post.distance)">
              <button id="xxxx-test" @click="jump('/merchant_info', '12345', 12436)"></button>
    ...
    <div class="footer">
      <div class="button-container" id="home" @click="jumpTwo('/')">
        ...
        <p style="margin:0" :style="{color: restText}">Merchants</p>
      </div>
